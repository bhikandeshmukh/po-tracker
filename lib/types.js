...
/**
 * @typedef {Error & { code?: string, details?: Record<string, string> }} ValidationError
 */
 ...
 * @param {z.ZodObject<any>} schema - Original Zod object schema
 * @returns {z.ZodObject<any>} Partial schema
 */
export function createPartialSchema(schema) {
    // In Zod v4, partial() is available on ZodObject

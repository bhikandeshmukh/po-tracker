        ...
        .items(
            Joi.object({
                ...
                poQuantity: Joi.number()
                    ...
                    .required()
                    .messages({
                        'any.required': 'PO quantity is required',
                        'number.min': 'PO quantity must be at least 1',
                        'number.max': 'PO quantity cannot exceed 1,000,000',
                        'number.integer': 'PO quantity must be a whole number'
                    }),
                ...
                unitPrice: Joi.number()
                    ...
                    .messages({
                        ...
                        'number.max': 'Unit price cannot exceed 10,000,000'
                    }),
